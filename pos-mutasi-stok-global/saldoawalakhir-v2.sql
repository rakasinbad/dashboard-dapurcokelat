...
-- Current month's transactions per owner
...
SELECT 
    SUM(per_owner.start_balance) AS total_start_balance,
    SUM(per_owner.total_kredit) AS total_mutasi_masuk,
    SUM(per_owner.total_debet) AS total_mutasi_keluar,
    SUM(per_owner.calculated_balance) AS calculated_total_balance,
    SUM(per_owner.latest_balance) AS actual_total_balance,
    SUM(per_owner.calculated_balance) - SUM(per_owner.latest_balance) AS difference
FROM (
  SELECT 
         curr.owner,
