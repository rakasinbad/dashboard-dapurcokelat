select outlet as "Outlet", namaoutlet as "Nama Outlet", namakota as "Wilayah", tgl_trx as "Tanggal Trx", date_format(waktu, '%H:%i:%S') as "Waktu Trx", no_trx as "No. Trx", kode_promo as "Kode Promo", namapemesan as "Nama Customer", phone as "Phone", 
    remark as "Remark",
...
kategori.kategori as "SKU Category",
	...
	harga as "Price", qty as "Qty", sub_total as "Gross Sales", diskon_sku as "Discount", sub_total - diskon_sku as "Nett Sales", channel as 'Channel'
    from (
