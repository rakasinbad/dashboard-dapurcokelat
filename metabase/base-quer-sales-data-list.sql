-- https://dashboard.dapurcokelat.com/question/94-sales-data?periode=thismonth&outlet=&channel=GOFOOD&channel=GRABFOOD&channel=SHOPEE%20FOOD&no_trx= TABLE LIST
select
	outlet as "Outlet",
